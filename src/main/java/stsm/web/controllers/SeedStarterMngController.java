...
import stsm.buisness.entitys.Type;
import stsm.buisness.entitys.Feature;
import stsm.buisness.entitys.Row;
import stsm.buisness.entitys.SeedStarter;
import stsm.buisness.services.SeedStarterService;
import stsm.buisness.services.VarietyService;
...
public class SeedStarterMngController {
    ...
    public String saveSeedStarter(SeedStarter seedStarter, BindingResult bindingResult, ModelMap modelMap){
        if (bindingResult.hasErrors()){
            return "seedstartermng";
        }
        this.seedStarterService.add(seedStarter);
